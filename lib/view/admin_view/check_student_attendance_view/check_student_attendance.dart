...
class CheckStudentAttendanceView extends StatefulWidget {
  ...
  CheckStudentAttendanceView({super.key,required this.studentId});
              ...
              return snapshot.data!.docs.length == 0 ? Center(child: MyText(title: "Attendance is taken yet!",color: MyColors.whiteColor,fontSize: 20,fontWeight: FontWeight.bold,)) : Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ////////////////////////////////////////////////
                    StudenAttendanceGraph(studentId: widget.studentId,),
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      logedInUserDataGetx.userDataList[0].userType != 'admin' ? SizedBox() : Icon(
                                        Icons.delete,
                                        color: MyColors.whiteColor,
                                      ),
                                      SizedBox(
